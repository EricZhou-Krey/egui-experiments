...
const TITLE_RECT: (f32, f32, f32, f32) = (0.0, 0.0, 0.5, 0.2);
const PREVIEW_RECT: (f32, f32, f32, f32) = (0.0, 0.2, 0.6, 1.0);
const DESC_RECT: (f32, f32, f32, f32) = (0.6, 0.5, 1.0, 1.0);
...
fn title_content(ui: &mut egui::Ui) {
    egui::CentralPanel::default()
        ...
        .show(ui, |ui| {
            ui.centered_and_justified(|ui| ui.heading("MATH SIMULATIONS"));
        });
}
    ...
    egui::CentralPanel::default()
        ...
        .show(ui, |ui| {
            ui.centered_and_justified(|ui| {
                ui.heading("PROJECT PURPOSE:\nInteractive visualizations of complex logic...")
            });
        });
}
...
fn preview_content(ui: &mut egui::Ui) {
    egui::CentralPanel::default()
        .frame(LAYOUT_BLOCK_FRAME)
        .show(ui, |ui| {
            ui.centered_and_justified(|ui| ui.heading("[ EQUATION & GRAPH PREVIEW GOES HERE ]"));
        });
}
