...
const TITLE_RECT: (f32, f32, f32, f32) = (0.5, 0.0, 1.0, 0.2);
const DESC_RECT: (f32, f32, f32, f32) = (0.6, 0.2, 1.0, 1.0);
const PREVIEW_RECT: (f32, f32, f32, f32) = (0.0, 0.5, 0.6, 1.0);
...
fn title_content(ui: &mut egui::Ui) {
    egui::CentralPanel::default()
        ...
        .show(ui, |ui| {
            ui.centered_and_justified(|ui| ui.heading("TABLETOP SOUND"));
        });
}
    ...
    egui::CentralPanel::default()
        ...
        .show(ui, |ui| {
            ui.centered_and_justified(|ui| {
                ui.heading("PROJECT PURPOSE:\nRaytraced acoustic simulation for TTRPGs...")
            });
        });
}
...
fn preview_content(ui: &mut egui::Ui) {
    egui::CentralPanel::default()
        .frame(LAYOUT_BLOCK_FRAME)
        .show(ui, |ui| {
            ui.centered_and_justified(|ui| ui.heading("[ SOUND PROPAGATION PREVIEW GOES HERE ]"));
        });
}
