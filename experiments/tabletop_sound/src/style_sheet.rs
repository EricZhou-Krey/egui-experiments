...
pub const MAP_CONVEXHULL_ICON: &str = "C";
...
pub const MAP_LINE_STROKE_WIDTH: f32 = 2.0;
pub const MAP_LINE_COLOR: egui::Color32 = egui::Color32::from_rgb(180, 180, 180);

pub const MAP_FACE_FILL_COLOR: egui::Color32 =
    egui::Color32::from_rgba_premultiplied(100, 150, 200, 30);
pub const MAP_FACE_BORDER_STROKE_WIDTH: f32 = 1.0;
pub const MAP_FACE_BORDER_COLOR: egui::Color32 =
